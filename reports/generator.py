...
<div class="container">
    ...
    <div class="footer">
        Generated by <strong>SentinelWP v3.6.0</strong> — Enterprise WordPress Vulnerability Intelligence &amp; Hardening Platform
    </div>
</div>
...
def generate_excel_report(scan) -> bytes:
    ...
    for f in scan.findings:
        ...
        if s in counts:
            counts[s] += 1
        if _get_raw_data(f).get("kev_listed"):
            has_kev = True
...
if HAS_REPORTLAB:
    class NumberedCanvas(canvas.Canvas):
        ...
        def draw_page_decorations(self, page_count):
            ...
            footer_text = "SentinelWP v3.6.0 — Confidential Security Assessment Report"
...
def generate_pdf_report(scan) -> bytes:
    ...
    summary_rows = [
        ...
        [
            ...
            Paragraph("SentinelWP v3.6.0 Enterprise", cell_body_style),
        ]
    ]
